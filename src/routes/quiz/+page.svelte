...
<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR-XVY-C6lowF0BWYmoqrT4eRPpeaMogPLTTQ&s" alt="" class="mb-10 h-25 w-auto">

<div class=" w-full h-screen flex flex-col items-center gap-5">
    <button class="text-white font-semibold text-4xl bg-[#90d63a] rounded-full w-[60%] border-white border-3 border-b-15 py-2 hover:bg-[#7fc727]"><a href="/" target="" rel="noopener noreferrer">Slang</a></button>
